...
const mockData = [
    {
        ...
        duration: 12,
        calories: 120,
        image: require('../../media/pictures/womanhelping.png'),
    },
    {
        id: '2',
        type: 'workout-full',
        ...
        duration: 12,
        calories: 120,
        image: require('../../media/pictures/womanhelping2.png'),
    },
    {
        id: '3',
        type: 'workout-split',
        ...
        calories: 1300,
        exercises: 5,
        image: require('../../media/pictures/gym1.png'),
    },
    {
        id: '4',
        ...
        duration: 6,
        calories: 200,
        image: require('../../media/pictures/gym2.png'),
    },
    {
        id: '5',
        type: 'workout-split',
    ...
    },
    {
        ...
        duration: 10,
        calories: 350,
        image: require('../../media/pictures/gym3.png'),
    },
];
            ...
            <TouchableOpacity style={styles.cardFullContainer}>
                <ImageBackground source={item.image} style={styles.cardFullBackground} imageStyle={{ borderRadius: 20 }}>
                    <View style={styles.cardOverlay}>
                        <Image source={require('../../media/pictures/whitestar.png')} style={styles.starIcon} />
                        ...
                        <Image source={require('../../media/pictures/playvideo.png')} style={styles.playIcon} />
                    </View>
                </ImageBackground>
            </TouchableOpacity>
        );
        ...
        return (
            <TouchableOpacity style={styles.cardSplitContainer}>
                ...
                <View style={styles.cardSplitImageContainer}>
                    ...
                    <Image source={require('../../media/pictures/whitestar.png')} style={[styles.starIcon, { top: 8, right: 8 }]} />
                </View>
            </TouchableOpacity>
        );
    }
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <TouchableOpacity style={styles.arrowSearchContainer}>
                    <Image source={require('../../media/pictures/Arrow.png')} />
                    <Text style={styles.txtsize20bold}>Search</Text>
                </TouchableOpacity>
                <View style={styles.headerIcon}>
                    <TouchableOpacity>
                        <Image style={{ marginEnd: 21 }} source={require('../../media/pictures/Notifications.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity>
                        <Image source={require('../../media/pictures/User.png')} />
                    </TouchableOpacity>
                </View>
            </View>
