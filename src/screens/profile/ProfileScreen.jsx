            ...
            <View style={styles.optionContainer}>
                ...
                >
                    ...
                    <View style={styles.iconItemOption}>
                        <Image style={styles.tintblack} source={require('@assets/images/arrowright.png')} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.itemOption}>
                    <View style={styles.imageItemContainer}>
                        <Image style={{ tintColor: '#fff' }} source={require('@assets/images/tutorial.png')} />
                    </View>
                    <View>
                ...
                <TouchableOpacity style={styles.itemOption}>
                    <View style={styles.imageItemContainer}>
                        <Image style={{ tintColor: '#fff' }} source={require('@assets/images/contract.png')} />
                    </View>
                    <View>
                ...
                <TouchableOpacity style={styles.itemOption}>
                    <View style={styles.imageItemContainer}>
                        <Image style={{ tintColor: '#fff' }} source={require('@assets/images/password.png')} />
                    </View>
                    <View>
